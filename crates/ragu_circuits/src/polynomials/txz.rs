//! Circuit evaluation of the $t(X, Z)$ polynomial.
...
/// Routine for evaluating the $t(X, Z)$ polynomial.
#[derive(Clone)]
pub struct Evaluate {
    log2_n: u32,
    n: u64,
...
impl Evaluate {
    /// Creates a new $t(X, Z)$ evaluator for a given [`Rank::log2_n`](super::Rank::log2_n).
