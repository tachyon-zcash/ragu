...
pub struct DStage<HostCurve, const NUM_CIRCUITS: usize> {
...
impl<HostCurve: CurveAffine, R: Rank, const NUM_CIRCUITS: usize> Stage<<HostCurve>::Base, R>
    for DStage<HostCurve, NUM_CIRCUITS>
{
    type Parent = ();
    ...
    type OutputKind = Kind![<HostCurve>::Base; DStageOutput<'_, _, HostCurve, NUM_CIRCUITS>];
