...
use crate::composition::staging::g_stage::{NUM_FINAL_EVALS, NUM_V_QUERIES};
use crate::{
...
impl<NestedCurve> Default for GVComputationStagedCircuit<NestedCurve> {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_g_stage_v_computation_valid() {
        ...
        let result = circuit.rx::<Rank>(witness, Fp::ONE);
