...
fn expected(name: &str, point: &str) -> Census {
    ...
    let (pinned, rejected) = match (name, point) {
        ...
        ("bind_beta", _) => (109, 627),
        ("bind_endoscalar", "seeded") => (50, 268),
        ("bind_endoscalar", "leaves") => (47, 271),
        ("bind_endoscalar", "nodes") => (50, 268),
        (step, "seeded") if step.starts_with("native_endoscaling_step_") => (49, 135),
        (step, "leaves") if step.starts_with("native_endoscaling_step_") => (46, 138),
        (step, "nodes") if step.starts_with("native_endoscaling_step_") => (49, 135),
        ("nested_export", "seeded") => (115, 650),
        ("nested_export", "leaves") => (116, 649),
        ("nested_export", "nodes") => (119, 646),
        ("nested_collapse", "seeded") => (116, 661),
        ("nested_collapse", "leaves") => (116, 659),
        ("nested_collapse", "nodes") => (119, 656),
        ("nested_compute_v", "seeded") => (114, 651),
        ("nested_compute_v", "leaves") => (115, 650),
        ("nested_compute_v", "nodes") => (118, 647),
        (_, "seeded") => (49, 145),
        (_, "leaves") => (46, 148),
        (_, "nodes") => (49, 145),
