...
impl<C: Cycle, R: Rank, const HEADER_SIZE: usize> Application<'_, C, R, HEADER_SIZE> {
    ...
    pub fn fuse<'source, RNG: CryptoRng, S: Step<C>>(
        ...
        Point::constant(&mut dr, preamble.nested_commitment)?.sink(&mut dr, &mut transcript)?;
        ...
        Point::constant(&mut dr, error_m.nested_commitment)?.sink(&mut dr, &mut transcript)?;
        ...
        Point::constant(&mut dr, error_n.nested_commitment)?.sink(&mut dr, &mut transcript)?;
