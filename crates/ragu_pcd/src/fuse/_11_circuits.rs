...
impl<C: Cycle, R: Rank, const HEADER_SIZE: usize> Application<'_, C, R, HEADER_SIZE> {
    pub(super) fn compute_internal_circuits<RNG: CryptoRng>(
        ...
        let unified = native::unified::Instance {
            ...
            left_child_bridge_inner_error: preamble.left_child_bridges.inner_error.commitment,
            left_child_bridge_outer_error: preamble.left_child_bridges.outer_error.commitment,
            left_child_bridge_ab: preamble.left_child_bridges.ab.commitment,
            left_child_bridge_query: preamble.left_child_bridges.query.commitment,
            left_child_bridge_eval: preamble.left_child_bridges.eval.commitment,
            left_child_bridge_points: preamble.left_child_bridges.points.commitment,
            right_child_bridge_inner_error: preamble.right_child_bridges.inner_error.commitment,
            right_child_bridge_outer_error: preamble.right_child_bridges.outer_error.commitment,
            right_child_bridge_ab: preamble.right_child_bridges.ab.commitment,
            right_child_bridge_query: preamble.right_child_bridges.query.commitment,
            right_child_bridge_eval: preamble.right_child_bridges.eval.commitment,
            right_child_bridge_points: preamble.right_child_bridges.points.commitment,
