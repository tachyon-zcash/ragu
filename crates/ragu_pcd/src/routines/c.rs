...
#[derive(Clone)]
pub struct Evaluate<const MAX_CROSS: usize, const MAX_CIRCUITS: usize> {
    len: usize,
}

impl<const MAX_CROSS: usize, const MAX_CIRCUITS: usize> Evaluate<MAX_CROSS, MAX_CIRCUITS> {
...
impl<F: Field, const MAX_CROSS: usize, const MAX_CIRCUITS: usize> Routine<F>
    for Evaluate<MAX_CROSS, MAX_CIRCUITS>
{
...
mod tests {
    ...
    fn test_c_routine_equivalency() -> Result<()> {
        ...
        let routine = Evaluate::<MAX_CROSS, MAX_CIRCUITS>::new(LEN);
