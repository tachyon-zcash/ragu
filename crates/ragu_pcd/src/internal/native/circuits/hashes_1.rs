    ...
    MultiStageCircuit<C::CircuitField, R> for Circuit<'_, C, R, HEADER_SIZE, FP>
{
        ...
        Self: 'dr,
    {
        ...
        // k(y) evaluation (application_ky, unified_ky_values) is performed in
        // inner_collapse, which also has the preamble and outer_error stages.
        // Moved there to stay within the gate budget after unified instance
        // expansion.
