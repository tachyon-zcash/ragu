//! Native circuit binding the children's walked nested commitments to their native
...
/// Native circuit binding both children's transcript and persistent commitments.
///
