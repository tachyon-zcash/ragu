...
fn test_internal_circuit_constraint_counts() {
    ...
    check_constraints!(PartialCollapseCircuit, mul = 1755, lin = 1917);
    check_constraints!(FullCollapseCircuit,    mul = 810 , lin = 807);
    check_constraints!(ComputeVCircuit,        mul = 1138, lin = 1770);
}
...
fn test_native_registry_digest() {
    ...
    let expected = fp!(0x0e9b941c2c3bd41f03f23c1e4e53411456b6d946f8b9c956a54ede74f0f09cfc);
