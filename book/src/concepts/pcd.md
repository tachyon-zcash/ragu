...
- **Unbounded computation**: Chain together arbitrarily many steps with verification cost independent of the number of steps—verification is amortized into a single final linear-time check
