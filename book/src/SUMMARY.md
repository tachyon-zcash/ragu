...
[Introduction](Introduction.md)
  ...
  - [Design](design/index.md)
    ...
    - [Recursion](design/recursion/index.md)
      - [Protocol Mechanics](design/recursion/protocol.md)
      - [Curve Cycle](design/recursion/curve_cycle.md)
      - [Staging Polynomials](design/recursion/staging.md)
      - [Cross-Curve Commitments](design/recursion/nested_commitments.md)
      - [Public Inputs](design/recursion/public_inputs.md)
